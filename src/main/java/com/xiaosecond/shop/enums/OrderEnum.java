...
public class OrderEnum {
    ...
    public static Integer UN_PAY = 1;
    public static Integer UN_SEND = 2;
    public static Integer SENDED = 3;
    public static Integer FINISHED = 4;
    public static Integer CANCEL = 5;
    public static Integer REFUND_ING = 6;
